...
function evolucaoFromAgendamento(ag: Agendamento): EvolucaoForm {
  return {
    localizacaoAnatomica: ag.localizacaoAnatomica ?? '',
    tipoLesao: ag.tipoLesao ?? '',
    medidaComprimento: ag.medidaComprimento?.toString() ?? '',
    medidaLargura: ag.medidaLargura?.toString() ?? '',
    medidaProfundidade: ag.medidaProfundidade?.toString() ?? '',
    aspectoLeitoFerida: ag.aspectoLeitoFerida ?? '',
    exsudatoVolume: ag.exsudatoVolume ?? '',
    exsudatoCaracteristica: ag.exsudatoCaracteristica ?? '',
    condicaoBordas: ag.condicaoBordas ?? '',
    aspectoPerilesional: ag.aspectoPerilesional ?? '',
    sinaisFlogisticos: ag.sinaisFlogisticos == null ? '' : String(ag.sinaisFlogisticos),
    presencaOdor: ag.presencaOdor == null ? '' : String(ag.presencaOdor),
    limpezaRealizada: ag.limpezaRealizada ?? '',
    coberturasAplicadas: ag.coberturasAplicadas ?? '',
    produtosUtilizados: ag.produtosUtilizados ?? '',
    aceitacaoProcedimento: ag.aceitacaoProcedimento ?? '',
    escalaDor: ag.escalaDor?.toString() ?? '',
    intercorrencias: ag.intercorrencias ?? '',
    cuidadosCurativo: ag.cuidadosCurativo ?? '',
    sinaisAlerta: ag.sinaisAlerta ?? '',
    orientacaoRetorno: ag.orientacaoRetorno ?? '',
  }
}
