...
export default function ProntuarioPage() {
  ...
  const nomePaciente = prescricoes[0]?.pacienteNome || nomeQuery || 'Paciente'
  ...
  useEffect(() => {
    ...
    fetchPrescricoes()
  }, [usuario, hasRequiredRole, fetchPrescricoes])
        ...
        <div className="pront-page">
          ...
          <div className="pront-header">
            <div>
              ...
              <span className="pront-subtitulo">Prontuário · Prescrições</span>
            </div>
            <button
              className="presc-btn presc-btn-primario"
              onClick={abrirNova}
