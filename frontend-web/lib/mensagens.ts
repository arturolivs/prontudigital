...
export const MENSAGENS = {
  erro: {
    ...
    enviarAvatar: 'Erro ao enviar a foto de perfil.',
    removerAvatar: 'Erro ao remover a foto de perfil.',
    avatarTipoInvalido:
      'Formato não suportado. Envie uma imagem JPG, PNG ou WEBP.',
    avatarTamanho: 'Imagem muito grande. O tamanho máximo é 2 MB.',
  ...
  sucesso: {
    ...
    avatarAtualizado: 'Foto de perfil atualizada!',
    avatarRemovido: 'Foto de perfil removida.',
