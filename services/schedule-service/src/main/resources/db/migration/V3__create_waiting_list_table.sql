...
CREATE INDEX idx_waiting_list_professional_id ON waiting_list(professional_id);
...
CREATE INDEX idx_waiting_list_professional_status ON waiting_list(professional_id, status);
CREATE INDEX idx_waiting_list_created_at ON waiting_list(created_at);
CREATE UNIQUE INDEX uk_patient_professional_active ON waiting_list(patient_id, professional_id, status);
